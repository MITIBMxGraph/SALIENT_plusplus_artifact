...
max_num_nodes = config_info['max_num_nodes']
print(f'Will download partitioned versions of feasible datasets for # partitions <= max_num_nodes.')
print(f'Obtained max_num_nodes = {max_num_nodes} from configuration.')
